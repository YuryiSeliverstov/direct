...
class PopupController extends Controller
{
	...
	public function actionGet($id)
	{
		...
		$model=$this->loadModel($id);
		if (isset($model->attributes['enabled']) && $model->attributes['enabled'])
		{
			$model->setAttributes(['views'=>intval($model->attributes['views'])+1]);
			$model->save();
			$this->renderPartial('get',['model'=>$model],false,true);
		}
	}
